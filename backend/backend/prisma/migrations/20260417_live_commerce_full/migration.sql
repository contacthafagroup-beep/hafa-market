...
CREATE TABLE IF NOT EXISTS "live_messages" (
  ...
  "userAvatar"  TEXT,
  "type"        TEXT NOT NULL DEFAULT 'CHAT', -- CHAT|REACTION|QA|SYSTEM|ORDER
...
CREATE UNIQUE INDEX IF NOT EXISTS "live_products_sessionId_productId_key" ON "live_products"("sessionId","productId");
